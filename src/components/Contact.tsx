      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Каждый сильный сайт начинается с разговора. Расскажите о вашем проекте —
              и мы предложим решение, которое работает на ваш бизнес.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажите о вашем проекте — тип сайта, задачи, сроки..."
                  required
                />
              </div>
              <button
