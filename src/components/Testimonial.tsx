  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Kodo Studio создали нам сайт, который с первого месяца начал приносить клиентов. Они поняли наш бизнес лучше, чем мы ожидали —
          дизайн работает как молчаливый продавец.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Сергей Романов</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Основатель юридической компании</p>
        </div>
      </div>
    </section>
  )
